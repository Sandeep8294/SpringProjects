...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
    	registry.addViewController("/").setViewName("http://192.168.45.219:8080/auth/realms/bdb-dev/login-actions/authenticate?client_id=com%3Avdenotaris%3Aspring%3Asp&tab_id=m_2Nk1pVQAA");
