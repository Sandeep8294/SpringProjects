 ...
 * 
 * import org.springframework.mock.web.MockHttpSession; import
 ...
 * 
 * public static final User USER_DETAILS = new User(USER_NAME, USER_PASSWORD,
 * AUTHORITIES);
 * 
 * public MockHttpSession mockHttpSession(boolean secured) { MockHttpSession
 * mockSession = new MockHttpSession();
 * 
 * SecurityContext mockSecurityContext = mock(SecurityContext.class);
 * 
 * if (secured) { ExpiringUsernameAuthenticationToken principal = new
 * ExpiringUsernameAuthenticationToken(null, USER_DETAILS, USER_NAME,
 * AUTHORITIES); principal.setDetails(USER_DETAILS);
 ...
 * return mockSession; }
 * 
 * public MockHttpSession mockAnonymousHttpSession() { MockHttpSession
 * mockSession = new MockHttpSession();
 * 
 * SecurityContext mockSecurityContext = mock(SecurityContext.class);
 * 
 * AnonymousAuthenticationToken principal = new AnonymousAuthenticationToken(
 * ANONYMOUS_USER_KEY, ANONYMOUS_USER_PRINCIPAL, AUTHORITIES);
 * 
 * when(mockSecurityContext.getAuthentication()).thenReturn(principal);
 * 
 * SecurityContextHolder.setContext(mockSecurityContext);
