 ...
 * org.springframework.security.saml.metadata.MetadataManager; import
 ...
 * 
 * @WebAppConfiguration public class SSOControllerTest extends CommonTestSupport
 * {
 * 
 * private static final Set<String> IDPS = Collections.unmodifiableSet( new
 * HashSet<>(Arrays.asList("idp1", "idp2", "idp3")));
 * 
 * @InjectMocks SSOController ssoController;
 * 
 * @Mock private MetadataManager metadata;
 * 
 ...
 * standaloneSetup(ssoController).setSingleView(mockView).build(); }
 * 
 * @Test
 * 
 * @WithMockUser public void testIdpSelectionWithUser() throws Exception {
 * mockMvc.perform(get("/saml/discovery")) .andExpect(status().isOk())
 * .andExpect(view().name("redirect:/landing")); }
 * 
 * @Test public void testIdpSelection() throws Exception { // given
